                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                    ...
                    {isAdmin && (
                      <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                        ...
                        <button onClick={() => handleDeleteMember(m.id, m.name)} style={{ background: "transparent", border: "1px solid rgba(255,85,85,0.3)", color: C.red, borderRadius: 7, padding: "5px 10px", cursor: "pointer", fontSize: 11, fontWeight: 600 }}>Remove</button>
